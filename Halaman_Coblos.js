...
function confirmVote(electionType) {
    ...
    if (checkbox.checked) {
        ...
        window.location.href = 'vote' + electionType + '.html'; // Redirect to voting page
    } else {
        showNotification('agreementModal'); // Show notification only if checkbox isn't checked
    }
}

function validateForm() {
    var checkBox = document.getElementById("agreePemilu"); // Assume 'agreePemilu' is correct, adjust if necessary
